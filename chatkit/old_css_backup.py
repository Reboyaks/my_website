...
.st-key-theme_button button:hover {
...
.light-mode .toolkit-title,
.light-mode .final-cta-title,
.light-mode .funnel-detail-title,
...
.light-mode .toolkit-description,
.light-mode .final-cta-description,
.light-mode .cta-description,
.light-mode .resume-text {
    color: #626873 !important;
}
...
.light-mode .hero-button.primary {
    background: #7c3aed !important;
...
.light-mode .toolkit-card {
    background: #ffffff !important;
    border-color: #e5e7eb !important;
}

.light-mode .toolkit-card:hover {
...
.light-mode .funnel-detail {
    background: #ffffff !important;
    border-color: #7c3aed !important;
}

.light-mode .funnel-detail-description,
.light-mode .funnel-outcome-text {
    color: #626873 !important;
}

.light-mode .funnel-container div[data-testid="stButton"] > button {
    background: #ffffff !important;
    color: #374151 !important;
    border-color: #e5e7eb !important;
}

.light-mode .funnel-container div[data-testid="stButton"] > button:hover {
    background: #f0f1f3 !important;
}
...
.light-mode .contact-button.primary {
    background: #7c3aed !important;
    border-color: #7c3aed !important;
    color: #ffffff !important;
}
...
.light-mode .st-key-theme_button button {
    background: #ffffff !important;
    border-color: #dedfe3 !important;
    color: #171717 !important;
}
